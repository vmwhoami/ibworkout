...
import { Barbel, Question, Present, Clock, Package, Trophy } from '../components/Svgs'
    ...
    <div className="steps__left">
      <div className="steps__wrapper reverse">
        <div className="steps__textwrap">
          ...
          <p>Каждый из них решает разные задачи:
      ...
      <div className="steps__wrapper reverse">
        <div className="steps__textwrap">
          ...
          <p>Заполните короткую анкету, и мы составим для
             вас оптимальную программу.</p>
        </div>
        <div className="steps__svgwrap">
          <Question />
        </div>
      ...
      <div className="steps__wrapper reverse">
        <div className="steps__textwrap">
          ...
          <p>Начните заниматься с выбранным тренером бесплатно:
            так вы поймете, подходят ли вам программа и формат занятий.</p>
        </div>
    ...
    <div className="steps__right">
      ...
      <div className="steps__wrapper">
        ...
        <div className="steps__textwrap">
          ...
          <p>Определите комфортную нагрузку и тренируйтесь один, два или три раза в неделю от 825 руб./час.</p>
        </div>
      </div>
